...
def set_loader():
    ...
    custom_val_dataset = CustomDataset(root='/home/dsosatr/tesis/DYB-linearHead/test/', transform=val_transform)
...
def main():
    ...
    CKPT_PATH = '/home/dsosatr/tesis/cnnmodel/SupContrast/save/SupCon/path_models/SupCon_path_resnet50timm_lr_0.016_decay_0.0001_bsz_32_temp_0.07_trial_0_cosine_warm/ckpt_epoch_900.pth'
